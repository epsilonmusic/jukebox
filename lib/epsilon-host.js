...
EpsilonHost.prototype.stop = function () {
...
EpsilonHost.prototype.connectToMPD = function () {
  var self = this;
...
EpsilonHost.prototype.requeue = function () {
  ...
  console.log("Clearing and re-queueing");

  this.mpdClient.sendCommand(mpd.cmd("clear", []));

  console.log("Updating database");

  this.mpdClient.on("system-player", function () {
    self.sendPosition();
  });
